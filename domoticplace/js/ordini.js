...
function invia(){
    ...
    if(count==6){
        ...
        document.getElementById('mail').innerHTML = "<a href='mailto:lolloriz36@gmail.com,"+email+"?subject="+ordine+"&body=Salve%20Rizzolo.%0AMi%20chiamo%20"+nome+"%20"+cognome+",%20abito%20in%20"+indirizzo+"%20e%20ti%20scrivo%20per%20un%20servizio%20di%20"+mode+".%0AAttendo una mail di conferma.'><button>Invia Email</button></a>";
    }else{
